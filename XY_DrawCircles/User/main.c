...
=================================测试程序================================
/*
* 本程序是本人在手搓3D打印机的过程中，为了测试XY轴联动功能而用AI生成的测试程序。
* 它可以让XY轴重复画圆圈。适合测试的XY轴联动功能是否正常，如果打印机XY轴安装
* 不合理可能会导致电机卡住。
* 用AI直接生成的，所有代码都放在main.c里面了，所以看起来有点乱（：
*
...
* 就行，减少繁琐的接线）。SLEEP，RESET和VDD接3.3V高电平，CMOT接24V电源。注意单片
* 机和驱动模块的电源共地。
*
*                                                       0xC0FFEE_ZY
*                                                       2026.5.18
